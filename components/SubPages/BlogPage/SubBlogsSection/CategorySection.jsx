const CategorySection = ({ blogsCategory, setBlogsCategory, categories }) => {
  return (
    <div className="flex items-center justify-end pb-8">
      <span className="inline-block pr-2 font-trade-gothic text-xs text-blue-500">
        Category
      </span>
      <span className="inline-block">
        <select
          name="category"
          id="category"
          className="rounded border border-gray-200 py-1 px-3 font-trade-gothic text-xs text-blue-500 focus:outline-none"
