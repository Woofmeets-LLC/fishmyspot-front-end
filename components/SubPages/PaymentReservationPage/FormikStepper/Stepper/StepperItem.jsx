  ...
  return (
    <>
      <div className="flex items-center relative">
        ...
        <div className={`absolute top-0 -ml-11 mt-8 sm:mt-9 md:mt-11 font-trade-gothic text-center ${title === 'Payment method' ? '-ml-3 sm:-ml-11 sm:w-[124px] md:w-[130px]' : 'w-28 sm:w-[120px] md:w-32'} text-sm md:text-lg ${index <= step ? 'text-highlight-3 font-trade-gothic-bold' : 'text-primary'}`}>{title}</div>
      </div>
      {
        totalStep - 1 != index &&
