...
const MessageCard = ({
  ...
  return (
    <div
      className={`${
        isActive === id
          ? 'md:bg-highlight-2 text-white'
          : 'hover:bg-gray-200 text-highlight-1'
      } rounded-xl mb-4 cursor-pointer`}
      ...
      <div className="md:p-2 xl:p-4 2xl:py-6 2xl:px-5">
        <div className="flex justify-center lg:justify-between items-center  font-trade-gothic">
          <div className="w-10 h-10 xs:w-12 xs:h-12">
            <FaUser className="w-full h-full rounded-full object-cover text-highlight-1" />
            {/* <img
