                ...
                isOpen && (
                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            className={`relative no-scrollbar z-[1501] w-auto min-w-[300px] max-w-[95vw] h-auto min-h-[150px] max-h-[95vh] overflow-x-hidden ${isOverflowY ? "overflow-y-auto overflow-custom" : " overflow-y-scroll "} ${isTransparentBG ? "bg-transparent" : "bg-white"}`}>
