...
const BookingReadyToReview = () => {
    ...
    useEffect(() => {
        ...
        getSdk().transactions.query({
            ...
            include: ['booking', 'listing', 'customer', 'reviews']
        })
            .then(res => {
                setLoading(false);
                ...
                <div className='container flex flex-col gap-4 lg:gap-5 pb-10 md:pb-12 lg:pb-16 2xl:pb-20'>
                    ...
                    <div className="mb-4">
                        <div className="flex gap-4">
                            ...
                            <span className="inline-block text-lg font-trade-gothic-bold pb-1 border-b-4 border-secondary cursor-pointer">Ready to review ({bookingList.length})</span>
                        </div>
                    </div>
                    {
                        loading
...
export default BookingReadyToReview;