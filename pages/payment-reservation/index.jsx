    ...
    <HomeLayout>
      <div className="container">
        <div className="lg:w-[800px] xl:w-[965px] mx-auto pt-6 xl:pt-10 pb-16 xl:pb-32">
          <div className="mb-11">
            <h1 className="text-xl sm:text-2xl md:text-3xl xl:text-4xl font-food-truck uppercase text-primary">
              PRICE CALCULATOR
            </h1>
            <p className="text-base xl:text-lg font-trade-gothic text-highlight-1 mt-2 md:mt-3 xl:mt-5">
