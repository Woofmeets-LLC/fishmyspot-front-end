  ...
  return (
    <HomeLayout>
      <div className="container my-10">
        <PageTitle title="Acceptable Use Policy" />

        <p className="mb-2">{`This acceptable use policy covers the products, services, and technologies
          (collectively referred to as the “Products”) provided by Fish My Spot under
          any ongoing agreement. It's designed to protect us, our customers, and the
          general Internet community from unethical, irresponsible, and illegal activity.`}</p>

        <p className="mb-2">FishMySpot customers found engaging in activities prohibited by this
          ...
          customers to the relevant authorities.</p>

        <p>This policy was last reviewed on 30 March 2022.</p>

        <SectionTitleDescription
          title={"Fair use"}
          descriptions={[`We provide our facilities with the assumption your use will be “business as usual”, as per our offer schedule. If your use is considered to be excessive, then additional fees may be charged, or capacity may be restricted.`,
        ...
        <SectionTitleDescription
          title={"Unauthorized use of FishMySpot property"}
          descriptions={[
            `We prohibit the impersonation of Fish My Spot, the representation of a significant business relationship with Fish My Spot, or ownership of any Fish My Spot property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust.`
          ]}
        />
